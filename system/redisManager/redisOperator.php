...
class redisOperator
{
    ...
    {
        return md5(json_encode($arrRedisConf));
    }
    ...
    //listFindAll
    public function WYlRange($strKey)
    {
    ...
    //hashDel
    public function WYhDel($strKey, $mixValue)
    {
    ...
    //set
    public function WYset($strKey, $strValue, $expireTime = -1)
    {
    ...
    // setnx
    public function WYsetnx($key,$expiretime) {
        return $this->redis->setnx($key,$expiretime);
    }
